...
<div class="card mb-4">
  <h5 class="card-header">تعديل عرض</h5>

  <form class="card-body" action="/update_offer" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-2">
        ...
        <!-- <div class="input-group input-group-merge"> -->
          <input  name="discount" type="text" value="<?php echo $params->discount ; ?>" class="form-control"  aria-describedby="multicol-email2" />
          
     </div>
      <div class="col-md-3">
        <label class="form-label" for="multicol-username">بدايه العرض  </label>
        <input name="start_date" type="date" value="<?php echo $params->start_date ; ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-3">
        <label class="form-label" for="multicol-username">نهاية العرض  </label>
        <input name="end_date" type="date" value="<?php echo $params->end_date ; ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
