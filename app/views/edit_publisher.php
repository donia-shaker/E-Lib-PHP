...
?>
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input name="name" type="text" value="<?php echo $params->name ; ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">صورة دار النشر</label>
        <div class="input-group input-group-merge">
          <input  name="image" type="file" value="<?php echo $params->image ; ?>" class="form-control"  aria-describedby="multicol-email2" />
    ...
    <div class="row g-3">
        <div class="col-md-3">
        <label class="form-label" for="multicol-username">الايميل  </label>
        <input name="email" value="<?php echo $params->email ; ?>" type="email" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-3">
        ...
        <div class="col-md-3">
        <label class="form-label" for="multicol-username">الهاتف البديل</label>
        <input name="alt_phone" type="number" value="<?php echo $params->alt_phone ; ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
        <div class="col-md-3">
        <label class="form-label" for="multicol-username"> الفاكس</label>
        <input name="fax" type="text" value="<?php echo $params->fax ; ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
        <div class="col-md-3">
        <label class="form-label" for="multicol-username"> العنوان</label>
        <input name="address" type="test" value="<?php echo $params->address ; ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
              <div class="col-md-3">
        <label class="form-label" for="multicol-username"> الدولة</label>
        <input name="country"  value="<?php echo $params->country ; ?>" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
