...
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, offer-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
          ...
          <tr>
            ...
            <a href="/edit_offer/<?php echo $offer['id'];?>" class="btn btn-icon btn-outline-dribbble">
              ...
              <button type="button" class="btn btn-icon btn-outline-dribbble">
                  <a href="/remove_offer/<?php echo $offer['id'];?>" class="btn btn-icon btn-outline-dribbble">
