...
<div class="card mb-4">
  <h5 class="card-header">اضافة دار نشر </h5>
  <form class="card-body" action="/save_publisher" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-3">
        ...
        <input name="alt_phone" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
        <div class="col-md-3">
        ...
        <input name="address" type="test" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
              <div class="col-md-3">
