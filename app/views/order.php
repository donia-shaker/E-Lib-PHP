...
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, order-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
          ...
          <tr>
            ...
            <a href="/edit_order/<?php echo $order['id'];?>" class="btn btn-icon btn-outline-dribbble">
              ...
              <button type="button" class="btn btn-icon btn-outline-dribbble">
                  <a href="/remove_order/<?php echo $order['id'];?>" class="btn btn-icon btn-outline-dribbble">
