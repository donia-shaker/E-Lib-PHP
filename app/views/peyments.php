    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-bordered">
        ...
        <tbody>
         ...
         <?php 
          foreach($params as $peyment){?>
          <tr>
            
            <td><?= $peyment['name'];?></td>
            <td>
              <img class="img-fluid rounded" height="150px" width="150px" src="images/<?= $peyment['image'];?>">
            </td>
            <td>
            <?php if($peyment['is_active']==1) {?>    
            ...
            <td>
            <a href="/edit_peyment/<?php echo $peyment['id'];?>" class="btn btn-icon btn-outline-dribbble">
                <i class="tf-icons bx bx-edit-alt me-1"></i>
              </a>
              <button type="button" class="btn btn-icon btn-outline-dribbble">
                  <a href="/remove_peyment/<?php echo $peyment['id'];?>" class="btn btn-icon btn-outline-dribbble">
