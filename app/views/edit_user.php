...
<div class="card mb-4">
  ...
  <form class="card-body" action="/update_user" method="POST" enctype="multipart/form-data">
...
?>
    <div class="row g-3">
      ...
      <div class="col-md-4">
        ...
        <input name="email" value="<?php echo $params->email ; ?>" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
    <div class="col-md-2">
        <label class="form-label" for="multicol-username"> الصلاحيات</label>
        <select name="role_id" id="multicol-username" class="form-control">
