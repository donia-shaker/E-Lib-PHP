        ...
        <tbody>
         ...
         <?php 
          ...
          <tr>
            ...
            <td>
            <a href="/edit_city/<?php echo $city['id'];?>" class="btn btn-icon btn-outline-dribbble">
                <i class="tf-icons bx bx-edit-alt me-1"></i>
              </a>
              <button type="button" class="btn btn-icon btn-outline-dribbble">
                  <a href="/remove_city/<?php echo $city['id'];?>" class="btn btn-icon btn-outline-dribbble">
