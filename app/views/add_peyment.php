...
<div class="card mb-4">
  <h5 class="card-header">فاتورة جديد</h5>
  <form class="card-body" action="/save_peyment" method="POST" enctype="multipart/form-data">
    
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">اسم الفاتورة</label>
        <input name="name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">صورة </label>
